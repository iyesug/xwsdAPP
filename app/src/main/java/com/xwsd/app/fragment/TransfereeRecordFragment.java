 ...
 * 受让记录
 */
public class TransfereeRecordFragment extends BaseUpDownListFragment {
 ...
 //   DecimalFormat decimalFormat = new DecimalFormat("0.0");
    ...
    private void setData(CreditorTransferBean bean, int type) {
        ...
        if (mAdapter == null) {
            mAdapter = new QuickAdapter<CreditorTransferBean.Data.Records>(getActivity(), R.layout.item_transferee_record, bean.data.records) {
                @Override
                protected void convert(BaseAdapterHelper helper, final CreditorTransferBean.Data.Records item) {
                    ...
                    helper.setOnClickListener(R.id.prot_jia,new View.OnClickListener(){
                        @Override
                        public void onClick(View v) {
                            BuriedPointUtil.buriedPoint("持有中加息按钮");
                    ...
                    helper.setOnClickListener(R.id.prot_detail,new View.OnClickListener(){
                        @Override
                        public void onClick(View v) {
                            BuriedPointUtil.buriedPoint("持有中明细按钮");
