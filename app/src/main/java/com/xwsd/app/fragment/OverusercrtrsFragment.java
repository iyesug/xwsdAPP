...
public class OverusercrtrsFragment extends BaseUpDownListFragment {
  ...
  //  DecimalFormat decimalFormat = new DecimalFormat("0.0");
    ...
    private void setData(CreditorTransferBean bean, int type) {
        ...
        if (mAdapter == null) {
            mAdapter = new QuickAdapter<CreditorTransferBean.Data.Records>(getActivity(), R.layout.item_transferee_records, bean.data.records) {
                @Override
                protected void convert(BaseAdapterHelper helper, final CreditorTransferBean.Data.Records item) {
                    helper.setText(R.id.tv_continue_time, item.time);
                    ((TitleTextView) helper.getView(R.id.tv_money)).setContent((item.money) + "元");
                    ...
                    helper.setOnClickListener(R.id.prot_bid, new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            BuriedPointUtil.buriedPoint("账户债权转让受让记录原标查询");
                    ...
                    helper.setOnClickListener(R.id.prot_detail, new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            BuriedPointUtil.buriedPoint("已回款明细按钮");
