...
import com.xwsd.app.activity.AutoBidJianSettingActivity;
import com.xwsd.app.activity.AutoBidSettingActivity;
                        ...
                        if(autoInfoBean.data.autoInvest.mode.equals("0")){
                            navbarManage.setOnRightClickListener(new NavbarManage.OnRightClickListener() {
                                ...
                                public void onRightClick() {
                                    Intent intent = new Intent(TestActivity.this, AutoBidSettingActivity.class);
                                    startActivity(intent);
                                }
                            });
                        }else {
                            navbarManage.setOnRightClickListener(new NavbarManage.OnRightClickListener() {
                                @Override
                                public void onRightClick() {
                                    Intent intent = new Intent(TestActivity.this, AutoBidJianSettingActivity.class);
                                    startActivity(intent);
                                }
                            });
                        }
