...
public class CalendarAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        sp.setSpan(new RelativeSizeSpan(1.0f), 0, d.length(),
        ...
        if (position < daysOfMonth + dayOfWeek && position >= dayOfWeek) {
            // 当前月信息显示
            textView.setTextColor(context.getResources().getColor(R.color.gray_1));// 当月字体设黑
        }
     ...
     * @param posi     更新的位置
     * @param gridView
     * @param imgRes   图片的资源地址
     */
    public void updataView(int posi, GridView gridView, int imgRes) {
        try {//TODO 滑动中点击条目空指针
            View view = gridView.getChildAt(posi);
