...
public class DonutProgress extends View {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    ...
                    handler.postDelayed(updateProgress, delayTime);
                    break;
            }
     ...
     */
    public void setLoadAnimation(int schedule, int delayTime) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!TextUtils.isEmpty(text)) {
            ...
            //TODO 这里判断是否需要换行
            if (text.contains("&")) {
                canvas.drawText(text.split("&")[0], (getWidth()
                        - textPaint.measureText(text.split("&")[0])) / 2.0f, (getWidth() - textHeight) / 2.5f, textPaint);
                canvas.drawText(text.split("&")[1], (getWidth()
                        - textPaint.measureText(text.split("&")[1])) / 2.0f, (getWidth() - textHeight) / 1.5f, textPaint);
            } else {
                canvas.drawText(text, (getWidth()
                        - textPaint.measureText(text)) / 2.0f, (getWidth() - textHeight) / 2.0f, textPaint);
            }
        }
